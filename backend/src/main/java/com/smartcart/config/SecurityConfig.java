    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/products/**", "/categories/**", "/reviews/product/**", "/recommendations/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/recommendations/view/**").permitAll()
